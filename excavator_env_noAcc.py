...
class ExcavatorEnv(gym.Env):
    ...
    def set_action(self, action):
        ...
        self._joint_2_velocity_pub.publish(action[1])
        self._joint_3_velocity_pub.publish(action[2])
        self._joint_4_velocity_pub.publish(action[3])
        time.sleep(0.15)
    ...
    def compute_reward(self, observations, done):
        ...
        if not done:
            ...
            if 0.25 < joint_2_angle < 0.35:
                reward_joint_2 = - joint_2_angle * 10
            ...
            if bottom < 2.5:
                reward_bottom = -1000 + (bottom - 2) * 2000
            else:
                reward_bottom = 0
            ...
            reward = round(reward_distance, 3)  + reward_joint_2 + reward_joint_3 + reward_joint_4 + reward_bottom
