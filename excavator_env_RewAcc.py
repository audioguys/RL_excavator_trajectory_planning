...
reg = register(
    id='excavator-v1',
    entry_point='excavator_env_RewAcc:ExcavatorEnv_v1',
    max_episode_steps = 128,
    )

class ExcavatorEnv_v1(gym.Env):
    ...
    def _get_observation(self):
        ...
        joint_1_vt_1 = self.joint_1_preVelocity    
        joint_1_vt = self.joint_1_velocity
        
        joint_2_vt_1 = self.joint_2_preVelocity    
        joint_2_vt = self.joint_2_velocity

        joint_3_vt_1 = self.joint_3_preVelocity    
        joint_3_vt = self.joint_3_velocity

        joint_4_vt_1 = self.joint_4_preVelocity    
        ...
        excavator_observations = [
            ...
            round(joint_1_vt_1, 8),
            round(joint_2_vt_1, 8),
            round(joint_3_vt_1, 8),
            round(joint_4_vt_1, 8),
            round(joint_1_vt, 8),
            round(joint_2_vt, 8),
            round(joint_3_vt, 8),
            round(joint_4_vt, 8),
        ...
        self.x_bot1.append(excavator_observations[13])
        ...
        savedata.tofile("/home/xiaofei/catkin_ws/src/excavator_training/plots/obs_RewAcc_1.bin")
    ...
    def compute_reward(self, observations, done):
        ...
        if not done:
            ...
            # We get the sum square changes of joints velocities
            vel_change_1 = np.square(observations[5] - observations[9])
            vel_change_2 = np.square(observations[6] - observations[10])
            vel_change_3 = np.square(observations[7] - observations[11])
            vel_change_4 = np.square(observations[8] - observations[12])
            ...
            if observations[5] * observations[9] < 0:
                reward_vel_1 += -100
            ...
            if observations[6] * observations[10] < 0:
                reward_vel_2 += -100
            ...
            if observations[7] * observations[11] < 0:
                reward_vel_3 += -100
            ...
            if observations[8] * observations[12] < 0:
                reward_vel_4 += -100

            # the bottom of the bucket should not lower than the ground
            if observations[13] < 2.3:
                reward_bottom =  -1000 * (observations[13]-2.3)
            else:
                reward_bottom = 0
            ...
            reward = round(reward_distance, 3)  + reward_joint_2 + reward_joint_3 + reward_joint_4 + reward_vel_1 + reward_vel_2 + reward_vel_3 + reward_vel_4 + reward_bottom
            ...
            savedata.tofile("/home/xiaofei/catkin_ws/src/excavator_training/plots/obs_ReAcc_reward.bin")
    ...
    def convert_obs_to_state(self,observations):
        ...
        joint_1_vt_1 = observations[5]
        joint_2_vt_1 = observations[6]
        joint_3_vt_1 = observations[7]
        joint_4_vt_1 = observations[8]
        joint_1_vt = observations[9]
        joint_2_vt = observations[10]
        joint_3_vt = observations[11]
        joint_4_vt = observations[12]
        bottom = observations[13]
    
        state_converted = [distance_to_dig, joint_1 ,joint_2, joint_3, joint_4, joint_1_vt_1, joint_2_vt_1,
        joint_3_vt_1, joint_4_vt_1, joint_1_vt, joint_2_vt, joint_3_vt, joint_4_vt, bottom]
